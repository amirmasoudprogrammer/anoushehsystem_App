    ...
    return (
        ...
        <div className="flex flex-col items-center justify-around container mt-36 m-auto">
            <div className="text-center">
                ...
                <p className="text-black font-medium md:text-4xl mt-5 dark:text-white">دوره مد نظر خود را پیدا کنید</p>
            </div>
