        ...
        <div className={`flex items-center  justify-between fixed ${show ? "md:right-0 right-0 " : "md:-right-56 -right-56"} transition transition-all ease-linear z-30 top-0 bottom-0 `}>
            <div className="h-full bg-amber-50 dark:bg-gray-800 w-56 flex items-start justify-start shadow flex-col ">
                ...
                <div className="flex items-center justify-between w-60 pr-5 pl-7 pt-3 ">
                    <span className="text-black size-25 dark:text-white"> حالت شب </span>
                    <div>
                        <label className="relative inline-block h-7 w-[48px] cursor-pointer rounded-full bg-gray-900 transition [-webkit-tap-highlight-color:_transparent] has-[:checked]:bg-[#1976D2]" >
                            <input type="checkbox" id="AcceptConditions" className="peer sr-only" value={checkbox} onChange={(e) => setCheckbox(e.target.value)} onClick={startdarkmode} />
