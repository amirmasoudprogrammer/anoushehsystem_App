...
function Footer(props) {
    return (
        <div className="flex flex-col items-center justify-between container mt-8">
            <div className="text-black md:flex justify-around w-screen items-center border-t-2 border-t-emerald-50 dark:border-t-zinc-800 pb-12 w-full m-auto pt-14  dark:bg-gray-800   ">
            ...
            <div className="text-black dark:text-white flex items-center justify-center w-screen border-t-2 border-t-emerald-50 dark:border-t-zinc-800 mt-0.5 m-auto text-center pt-5  dark:bg-gray-800 ">
